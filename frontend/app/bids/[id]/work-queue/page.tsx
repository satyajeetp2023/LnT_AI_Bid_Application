...
const emptyQueue:DepartmentWorkQueue={items:[],summary:{total:0,critical:0,high:0,overdue:0,unassigned:0,without_person:0,due_soon:0,red_escalations:0,amber_escalations:0},by_function:[],by_type:[],by_person:[],department_control:[],filter:{responsible_function:null,responsible_person:null},version:""};
