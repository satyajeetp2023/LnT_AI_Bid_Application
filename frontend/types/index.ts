export type Bid={id:number;bid_id:string;tender_reference_no:string;tender_name:string;client:string;contract_type:string;project_type:string;tender_due_date:string;current_stage:string;bid_status:string;bid_manager:string;updated_at:string};
